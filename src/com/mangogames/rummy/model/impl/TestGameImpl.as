...
public class TestGameImpl implements SerializableSFSType{ 
    ...
    public function get rake():Float{
           return  _rake
		}



    public function set rake(parrm:Float):void {
		_rake = parrm; 
	}
