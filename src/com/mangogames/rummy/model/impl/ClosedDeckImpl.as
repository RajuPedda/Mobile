...
public class ClosedDeckImpl implements SerializableSFSType{ 

	 private var _card:Array = new Array();

    public function get card():Array{
           return  _card
		}



    public function set card(parrm:Array):void {
		_card = parrm; 
	}
